  ...
  return (
    <Link to={'/rooms/' + room._id} onClick={()=>scrollTo(0,0)} key={room._id}
     className='relative max-w-70 w-full rounded-xl 
        ...
        <img src={room.images[0]} alt="" className='hover:scale-105 transition-all'/>
        {index %2===0 &&<p className='px-3 py-1 absolute top-3 left-3 text-xs bg-white font-medium text-gray-800 rounded-full'>Best Seller</p>}
