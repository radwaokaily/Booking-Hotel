  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        ...
        text-white bg-no-repeat bg-cover bg-center' style={{backgroundImage:`url(${item.image})`}}>
                    <p className="px-3 py-1 absolute top-4 left-4 text-xs bg-white font-medium text-gray-800 rounded-full">
                        {item.priceOff} % OFF
                    </p>
                    <div>
                    ...
                    <button className=' flex items-center gap-2 font-medium cursor-pointer my-5'>View Offers
